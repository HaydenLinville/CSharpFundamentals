...
namespace _04_Loops
{
    ...
    public class LoopExamples
    {
        ...
        {
            int studentCount = 12;
            //1 starting point, local variables
            ...
            string[] students = { "Jim", "John", "Hayden", "Bill" };
        ...
        public void DoWhileLoops()
        {
            ...
            do
            {
                ...
                iteractor++; //interator = interator + 1; interator += 1;
            }
            while (iteractor < 5);
